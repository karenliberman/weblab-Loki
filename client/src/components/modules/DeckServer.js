  ...
  render() {
    ...
    return (
      ...
      <div>
        ...
        {this.state.hand.map((card, index) => (<Card value={card.value} index={index} key={card._id} suit={card.suit} _id={card._id} playerMove={() => move(index, this.state.hand, this.state.cards, this.state.rule)}/>))}
